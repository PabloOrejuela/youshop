    ...
    <div class="col-md-12">
        ...
        <div class="card mb-4">
            <div class="card-header">
                <button class="btn btn-outline-info" type="button" id="btn-new-cliente">Registrar Nuevo Cierre de Caja</button>
            </div>
            <!-- /.card-header -->
                        ...
                        <?php
                            if ($cajas) {
                                foreach ($cajas as $caja) {
                                    ...
                                    if ($caja->estado === '0') {
                                        echo '<td><button class="btn btn-outline-info" type="button" id="btn-abrir-caja">Abir Caja</button></td>';
                                    }else{
                                        echo '<td><button class="btn btn-outline-success" type="button" id="btn-abrir-caja" disabled>Abir Caja</button></td>';
                                    }
