                        ...
                        <?php
                            if ($cierres) {
                                foreach ($cierres as $cierre) {
                                    ...
                                    echo '<td>'.$cierre->caja.'</td>';
                                    echo '<td>'.$cierre->fecha_inicio.'</td>';
                                    echo '<td>'.$cierre->fecha_cierre.'</td>';
                                    echo '<td>'.$cierre->monto_inicial.'</td>';
                                    echo '<td>'.$cierre->monto_final.'</td>';
                                    echo '<td>'.$cierre->total_ventas.'</td>';
                                    if ($cierre->estado === '0') {
                                        echo '<td>CERRADA</td>';
                                    }else{
                                        echo '<td>ABIERTA</td>';
                                    ...
                                    if ($cierre->estado === '1') {
                                        echo '<td><button class="btn btn-info" type="button" id="btn-abrir-caja">Cerrar Caja</button></td>';
                                    }else{
                                        echo '<td><button class="btn btn-outline-success" type="button" id="btn-abrir-caja" disabled>Cerrar Caja</button></td>';
                                    }
                                    echo '</tr>';
                                }
                            }
