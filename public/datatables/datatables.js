 ...
 *   https://datatables.net/download/#bs5/jq-3.7.0/moment-2.29.4/dt-2.3.0/af-2.7.0/r-3.0.4
 *
 * Included libraries:
 *   jQuery 3.7.0, Moment 2.29.4, DataTables 2.3.0, AutoFill 2.7.0, Responsive 3.0.4
 */
...
(function( factory ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		builder: "bs5/jq-3.7.0/moment-2.29.4/dt-2.3.0/af-2.7.0/r-3.0.4",
